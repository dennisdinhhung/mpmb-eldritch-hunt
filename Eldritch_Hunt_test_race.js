...
RaceList["accursed-tiefling"] = {
  regExpSearch: /accursedtiefling/i,
...
RaceList["doused cursed-blood"] = {
  ...
  trait : "Doused Cursed-Blood (+1 Dexterity, +1 Strength or Wisdom, +1 of your choice)",
...
RaceList["hulking cursed-blood"] = {
  ...
  trait : "Hulking Cursed-Blood (+1 Dexterity, +1 Constitution, +1 of your choice)",
	languageProfs : ["Common", "Draconic or Infernal"],
  features: {
    vigilant_nature: {
      name: "Vigilant Nature",
...
RaceList["mirage cursed-blood"] = {
  ...
  scores : [0, 1, 0, 0, 0, 0], //[Str, Dex, Con, Int, Wis, Cha]
  trait : "Mirage Cursed-Blood (+1 Dexterity, +1 Interlligence or Charisma, +1 of your choice)",
	languageProfs : ["Common", "Draconic or Infernal"],
  features: {
    vigilant_nature: {
      name: "Vigilant Nature",
...
RaceList["oculare demidritch"] = {
  ...
  savetxt : { //part of Astral Being
		text : ["You are born of the galaxies and their endless void"],
		adv_vs : ["blinded"]
	},
  skills : ["Perception"],
  features: {
...
RaceList["deep-one-dwarf"] = {
  ...
  savetxt : { //part of Otherworldly Resilience
...
//     walk: { spd: 30, enc: 25 },
//   },
// 	scores : [0, 0, 2, 0, 0, 0], //[Str, Dex, Con, Int, Wis, Cha]
//   trait : "Manikin (+2 Constitution)",
...
RaceList["scourgeborne"] = {
  ...
  trait : "Scourgeborne (+1 Constitution)",
...
RaceList["belua scourgeborne"] = {
  ...
  trait : "Belua Scourgeborne (+1 Strength, +1 Constitution, +1 any of your choice)",
	languageProfs : ["Common", 1],
  vision : [["Darkvision", 108]],
  savetxt : { //part of Keen Hearing and Smell
		text : ["You have advantage on Perception checks that rely on hearing or smell."],
	},
  calcChanges: {
		atkAdd : [
			function (fields, v) {
...
RaceList["cervus scourgeborne"] = {
  ...
  speed: {
	...
	scores : [0, 0, 0, 1, 0, 0], //[Str, Dex, Con, Int, Wis, Cha]
  trait : "Cervus Scourgeborne (+1 Strength or Wisdom, +1 Constitution, +1 any of your choice)",
	languageProfs : ["Common", 1],
  vision : [["Darkvision", 108]],
  calcChanges: {
		atkAdd : [
...
RaceList["vespertilio scourgeborne"] = {
  ...
  trait : "Vespertilio Scourgeborne (+1 Dexterity, +1 Constitution, +1 any of your choice)",
	languageProfs : ["Common", 1],
  vision : [["Darkvision", 108]],
  calcChanges: {
		atkAdd : [
